...
- notes: capture_verified: false. Runtime host/port VALUES (lobby + game) beyond binary literals and the conn-state code meanings 201/202/203/232 stay capture/debugger-pending. Follow-up (IDB legibility): rename the `1/2` builder + the connect/host-store routines (still `sub_`-named) to reflect "game keepalive"/topology. Committed targeted on branch major-campaign.
