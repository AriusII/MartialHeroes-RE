...
| 1 | Account / CharacterMgmt | C2S **and** S2C | Mixed family. S2C minors 16/17/19/20 are server-command notifications (billing / letter). C2S minors 0/6/7/9/13/14 are the character-management request builders (logout / create / manage+delete / enter / rename / slot-move). The secure 1/4 auth-reply (credential carrier) is also emitted under major 1. |
