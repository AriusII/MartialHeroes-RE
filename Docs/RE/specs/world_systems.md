...
| `specs/cube_gamble.md` | The dice/cube high-low gambling panel (`4/99` / `4/100` / `2/141`): the phase state machine, the deterministic phase-5 **match evaluator** (signed money delta → win/loss/push; the 4-dice pair-sum / high-low-seven / odd-even / special-combination win-line matcher). |
