...
/// <b>no <c>case 8:</c></b>. The value <see cref="Exit"/> (8) is the <em>terminal loop-exit
/// sentinel</em>: states 6 and 7 (and <c>default</c>) all write field-0 to 8 before falling to the
