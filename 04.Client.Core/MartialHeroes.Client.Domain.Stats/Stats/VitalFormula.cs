...
///             <item>
///                 Stage 2 — integer flat base: <c>floor(score)</c> + equipment flat + set bonus + level base
///                 + server base.
///             </item>
///             <item>Stage 3 — percentage multiplier, then <c>floor(base * pct_mult)</c>.</item>
///         </list>
///         <c>floor</c> (truncation toward zero of a non-negative quantity) is applied at
///         <b>
///             exactly two
///             points
///         </b>
///         : the end of Stage 2 and the end of Stage 3 (spec: stats.md "floor is applied ...
