...
///         <c>display.lua</c>, <c>uiconfig.lua</c> and siblings) are
///         <b>
///             CP949 (code page 949,
///             EUC-KR)
///         </b>
///         , NOT UTF-8.  The prior UTF-8 claim ("N-B4-2") has been superseded by
...
public sealed partial class LuaConfigReader
{
    ...
    public LuaConfigRecord Parse(string luaSource)
    {
        ...
        return new LuaConfigRecord
        {
            ...
            AddictionWarningTiming = ReadInt(globals, "addiction_warning", 1), // key UNVERIFIED
    ...
    ///     spec: Docs/RE/specs/lua-config.md status-banner — "DISPLAY_GLOW_RANGE_X / _Y host fallback to 2 when read as 0 |
    ///     CODE-CONFIRMED"
    /// </summary>
