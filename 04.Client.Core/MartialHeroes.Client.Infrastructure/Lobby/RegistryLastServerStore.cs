...
public sealed class RegistryLastServerStore : ILastServerStore
{
    ...
    public void Save(ushort serverId)
    {
        ...
        try
        {
            ...
            using RegistryKey key = Registry.LocalMachine.CreateSubKey(WriteKeyPath, writable: true);
    ...
    public ushort Load()
    {
        ...
        try
        {
            ...
            // spec: Docs/RE/specs/login_flow.md §2.0 Registry note.
            using RegistryKey? key = Registry.LocalMachine.OpenSubKey(ReadKeyPath, writable: false);
