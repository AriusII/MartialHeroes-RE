...
///         <list type="bullet">
///             <item>
///                 If the grid is not loaded or the index is out of bounds → region id 0 →
///                 <see cref="ZoneType.Safe" />.<br />
///                 spec: Docs/RE/specs/world_systems.md Ch. 16 §16.1 — "yields region id 0": CONFIRMED.
///             </item>
///             <item>
///                 If region id ≥ 32 (no record in the table) → defaults to <see cref="ZoneType.OpenPvp" />
...
///             </item>
///             <item>
///                 If the raw zone-type value is 0, 1, or 2 → maps to the corresponding
...
///                 spec: Docs/RE/specs/world_systems.md Ch. 16 §16.3 — values 0/1/2 CONFIRMED, 3..31 = default (safe)
///                 CONFIRMED-COMPLETE.
///             </item>
///         </list>
///     </para>
