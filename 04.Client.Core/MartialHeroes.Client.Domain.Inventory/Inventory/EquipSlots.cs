...
public static class EquipSlots
{
    ...
    /// <summary>
    ///     Visual / appearance slot — an equip resolving here triggers a full visual gear rebuild. spec:
    ///     inventory_trade.md §1.2 / §10 (slot 15).
    /// </summary>
    ...
    /// <summary>
    ///     True when an equip resolving to <paramref name="slot" /> triggers the visual gear rebuild. spec:
    ///     inventory_trade.md §1.2 (slot 15).
    /// </summary>
    ...
    /// <summary>
    ///     True when <paramref name="slot" /> is skipped by the worn-item stat sum. spec: inventory_trade.md §1.2 /
    ///     combat.md §2.1.
    /// </summary>
