...
public enum EnchantOutcome
{
    ...
    /// <summary>
    ///     Success (success byte != 0): plays the success motion, applies the new +N. spec: inventory_trade.md §6.2
    ///     (motion 8).
    /// </summary>
    Success = 1
}
...
///         probabilities and the +N magnitude are server data and are never invented here. spec: inventory_trade.md
///         §6.2/§10.
///     </para>
/// </remarks>
public static class EnchantRules
{
    ...
    /// <summary>
    ///     The success motion id played on a successful upgrade. spec: inventory_trade.md §6.2 / §10 (motion 8 =
    ///     success).
    /// </summary>
    public const int SuccessMotionId = 8;

    /// <summary>
    ///     The fail / shatter motion id played on a failed upgrade. spec: inventory_trade.md §6.2 / §10 (motion 9 =
    ///     fail).
    /// </summary>
