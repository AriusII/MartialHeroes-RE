...
public static class MotionIntentMap
{
    ...
    ///   <item>otherwise <c>RunFlag != 0</c> ⇒ <see cref="MotionIntent.Run"/>, else <see cref="MotionIntent.Walk"/>.</item>
    /// </list>
    /// </para>
    /// <para>
    ...
    /// </remarks>
    public static MotionIntent Resolve(byte motionCode, byte runFlag) => motionCode switch
    {
