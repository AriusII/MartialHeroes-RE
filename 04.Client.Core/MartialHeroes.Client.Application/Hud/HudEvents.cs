...
{
    /// <summary>The HUD buff bar has exactly 30 icon slots. spec: Docs/RE/formats/misc_data.md §1.6; Docs/RE/packets/4-102_buff_state.yaml.</summary>
...
{
    /// <summary>The "no target" event: an unassigned key, blank name, zeroed bars. spec: Docs/RE/specs/combat.md §10.1 (selection cleared on world re-entry).</summary>
...
/// </remarks>
/// <param name="CurrentXp">Current experience within the level (64-bit accumulator). spec: Docs/RE/specs/progression.md §3.</param>
/// <param name="XpForLevel">Experience required to fill the current level (0 ⇒ unknown / max level). spec: Docs/RE/specs/progression.md §12 Q3.</param>
