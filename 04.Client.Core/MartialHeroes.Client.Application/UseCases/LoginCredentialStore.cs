...
///             <item>
///                 <description>
///                     <see cref="Username" /> — the account name string (also drives the 0x2B
///                     plaintext pre-image). Not part of the RSA crypto; encodes to the account bytes in the
///                     pre-image. spec: crypto.md §6.1 / §6.6.
///                 </description>
///             </item>
///             <item>
///                 <description>
///                     <see cref="AccountBytes" /> — CP949-encoded account bytes,
///                     WITHOUT the trailing NUL (the builder adds it). spec: login.yaml AccountLength.
///                 </description>
///             </item>
///             <item>
///                 <description>
///                     <see cref="StagedPasswordM" /> — the fixed 17-byte zero-padded RSA plaintext
...
///                     (DEBUGGER-VERIFIED 17-byte M).
///                 </description>
///             </item>
///             <item>
///                 <description>
///                     <see cref="PinBytes" /> — optional PIN bytes, without the trailing NUL.
...
///             <item>
///                 <description>
///                     <see cref="IncludePin" /> — whether the PIN region is appended to the pre-image
///                     (the a7 second-password gate). spec: packets/login.yaml (PIN GATE).
///                 </description>
///             </item>
///         </list>
///     </para>
...
public sealed class LoginCredentialStore
{
    ...
    ///     <list type="bullet">
    ///         <item>
    ///             <description>Encodes the account to CP949 bytes.</description>
    ///         </item>
    ///         <item>
    ///             <description>
    ///                 Produces the 17-byte zero-padded <c>M</c> buffer via
    ///                 <see cref="CredentialPlaintext.StagePassword" /> so the RSA half of the 1/4 reply can
    ///                 consume the correct fixed-width plaintext directly. spec: crypto.md §6.1, §6.6.
    ///             </description>
    ///         </item>
    ///         <item>
    ///             <description>
    ///                 Optionally encodes the PIN (a7-gated) to bytes.
    ///                 spec: login.yaml PIN GATE.
    ///             </description>
    ///         </item>
    ///     </list>
