...
///     logical reader that routes each through the <see cref="Network.Protocol.Routing.Routing.PacketRouter" /> into the
///     application's
...
public sealed class InboundFrameDispatcher
{
    ...
    /// <summary>
    ///     Routes a single frame synchronously through the <see cref="Network.Protocol.Routing.Routing.PacketRouter" /> into
    ///     the handler,
