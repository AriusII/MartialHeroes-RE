...
public static class CombatStatsRecomputer
{
    ...
    /// </summary>
    /// <param name="serverBases">
    ///     The five server-supplied primary-stat bases (from the 4/29 / 5/67 sync). spec: combat.md
    ///     §2/§6.
    /// </param>
    /// <param name="buffGrants">
    ///     Active buff slots paired with the stat they grant (data-supplied). spec: combat.md §2.2 /
    ///     skills.md §6.
    /// </param>
    ...
    /// <param name="ratingTerms">
    ///     The injected, non-stat rating composition terms (weapon/level/grade/slots). spec: combat.md
    ///     §3.3/§3.4.
    /// </param>
...
public readonly record struct CombatRatingTerms
{
    ...
    /// <summary>
    ///     Projects these terms plus the aggregated <paramref name="stats" /> into the attack-rating inputs. spec:
    ///     combat.md §3.3.
    /// </summary>
    ...
    /// <summary>
    ///     Projects these terms plus the aggregated <paramref name="stats" /> into the hit-rating inputs. spec: combat.md
    ///     §3.4.
    /// </summary>
