...
///         <list type="bullet">
///             <item>
///                 Call <see cref="LoadAreaAsync" /> when the active map area is set (alongside terrain / environment
///                 load).
///             </item>
///             <item>
///                 Call <see cref="UpdatePosition" /> each frame (or on significant player movement) with
///                 the player's current legacy world XZ position.
///             </item>
///             <item>
///                 The service publishes <see cref="ZoneChangedEvent" /> only when the resolved
