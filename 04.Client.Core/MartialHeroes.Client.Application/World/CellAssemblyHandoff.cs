...
///         <list type="bullet">
///             <item>
///                 <see cref="SectorStreamingService" /> keeps a flat <c>HashSet&lt;(mapX, mapZ)&gt;</c> resident
///                 set sized by the <c>StreamQuality</c> ring (3×3 / 5×5) — its job is "which sectors' BYTES are
///                 resident, load/evict the deltas". spec: terrain.md §9 (active set).
///             </item>
///             <item>
///                 The layer-03 <c>AreaComposer</c> owns the legacy <b>34-slot loader pool</b> (owner/recycle)
...
///                 Docs/RE/specs/assembly_graph.md §1/§4 (AreaComposer contract).
///             </item>
///         </list>
