...
///     <para>
///         PASSIVE: reads/writes client-local INI config (option.ini / DoOption.ini).
///         No use-case call; no opcode; no event channel drained here.
///     </para>
///     <para>
///         Character tab fully built. Sound/Graphic/Other tabs are shell stubs
///         (widget tables not yet swept — Open item 15 in the spec).
///     </para>
...
public sealed partial class HudOptionsWindow : Control
{
    ...
    private Control BuildCharacterSubPanel(HudAtlasLibrary atlas, HudTextLibrary text)
    {
        ...
        var checkX = OptW - 50f; // spec: ui_system.md §8.9 — "panelW − 50"
        for (var i = 0; i < 12; i++)
        {
