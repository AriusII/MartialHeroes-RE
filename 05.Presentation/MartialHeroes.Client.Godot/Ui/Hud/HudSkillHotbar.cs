...
/// src-rects from uitex key 3, default = ready state.</para>
///
...
public sealed partial class HudSkillHotbar : Control
{
    ...
    public void Build(HudAtlasLibrary atlas, HudIconLibrary icons)
    {
        ...
        AtlasTexture? readyTex =
            atlas.SliceById(OverlayTexId, OverlayReadySrcX, OverlayReadySrcY, OverlaySide, OverlaySide);
        AtlasTexture? cooldownTex = atlas.SliceById(OverlayTexId, OverlayCooldownSrcX, OverlayCooldownSrcY, OverlaySide,
            OverlaySide);
        AtlasTexture? chargeTex =
    ...
    ///
    /// <para>Only one of the three 29×29 overlay frames is visible at a time.
    /// Default = <see cref="SlotOverlayState.Ready"/> (the ready/empty frame).</para>
    ///
    /// spec: Docs/RE/specs/ui_hud_layout.md §5.10a — "three mutually-exclusive 29×29 frames
