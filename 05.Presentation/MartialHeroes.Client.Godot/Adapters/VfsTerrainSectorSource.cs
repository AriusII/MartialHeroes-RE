...
/// </summary>
internal sealed class VfsTerrainSectorSource : ITerrainSectorSource
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        if (_vfs is null || _manifestKeys is null)
        {
        ...
        string tedPath = BuildTedPath(_areaId, mapX, mapZ);

        ReadOnlyMemory<byte> bytes = TryGetContent(_vfs, tedPath);
    ...
    {
        string lstPath = BuildLstPath(areaId);
