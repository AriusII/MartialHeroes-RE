...
public sealed class AssembledCellViewAdapter : IAssembledCellView
{
    ...
    /// </summary>
    public global::MartialHeroes.Assets.Mapping.AssembledCell ConcreteCell => _cell;
    ...
    public bool IsResolved =>
        _cell.Slot0GroundTexGrid is not null || _cell.Slot1BuildingObjectGrid is not null;
}