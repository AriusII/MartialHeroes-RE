...
///   <item><see cref="IAssembledAreaView.Spawns"/> from <c>AssembledArea.Spawns</c>, projecting each
///     layer-03 <c>SpawnDescriptor</c> to a layer-04 <see cref="AreaSpawnDescriptor"/> (1:1 copy of
///     all five fields — no transformation).</item>
/// </list>
///
...
{
    private readonly global::MartialHeroes.Assets.Mapping.AssembledArea _area;
    ...
    public AssembledAreaViewAdapter(global::MartialHeroes.Assets.Mapping.AssembledArea area)
