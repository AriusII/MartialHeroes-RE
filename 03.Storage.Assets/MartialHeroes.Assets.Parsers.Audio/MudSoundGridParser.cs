...
///         spec: Docs/RE/formats/mud.md §Grid geometry — "Grid dimensions: 64 × 64 tiles. Tile stride: 8 bytes":
///         CONFIRMED.
///     </para>
///     <para>
...
///         spec: Docs/RE/formats/mud.md §Identification — "Endianness: little-endian (single-byte fields only)":
///         CONFIRMED.
///     </para>
...
public static class MudSoundGridParser
{
    ...
    public static MudSoundGrid Parse(ReadOnlySpan<byte> span)
    {
        ...
        var tileCount = MudSoundGrid.TileCount; // 4096
