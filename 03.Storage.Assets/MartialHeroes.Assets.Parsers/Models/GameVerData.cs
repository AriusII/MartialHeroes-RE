...
/// </summary>
/// <remarks>
/// spec: Docs/RE/formats/game_ver.md §7 — "flat array of 7 × u32, little-endian (28 bytes)":
///   CONFIRMED.
/// <para>
...
/// spec: Docs/RE/formats/game_ver.md §7 §Layout — "version_source (field5) @ 0x14": CONFIRMED.
/// </para>
...
public sealed record GameVerData
{
    ...
    /// spec: Docs/RE/formats/game_ver.md §7 §Layout — "field0 @ 0x00: UNVERIFIED (value present)".
    /// </summary>
