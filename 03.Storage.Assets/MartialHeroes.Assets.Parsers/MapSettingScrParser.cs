...
public static class MapSettingScrParser
{
    ...
    public static MapZoneRecord[] Parse(ReadOnlyMemory<byte> data)
    {
        ...
        for (int i = 0; i < count; i++)
        {
            ...
            int zoneId = BinaryPrimitives.ReadInt32LittleEndian(rec[0x00..]);
            ...
            float fogDensity = BinaryPrimitives.ReadSingleLittleEndian(rec[0x40..]);
            ...
            int unknown44 = BinaryPrimitives.ReadInt32LittleEndian(rec[0x44..]);

            // unknown_0x48 i32LE @ 0x48. UNKNOWN. Typically 0 or -1.
            // spec: Docs/RE/formats/misc_data.md §7.1 — "unknown_0x48 i32 @ 0x48: UNKNOWN".
            int unknown48 = BinaryPrimitives.ReadInt32LittleEndian(rec[0x48..]);
            ...
            int unknown4C = BinaryPrimitives.ReadInt32LittleEndian(rec[0x4C..]);
            ...
            int unknown50 = BinaryPrimitives.ReadInt32LittleEndian(rec[0x50..]);
