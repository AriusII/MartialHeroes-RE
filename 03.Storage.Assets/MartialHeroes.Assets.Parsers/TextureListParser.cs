...
public static class TextureListParser
{
    ...
    static TextureListParser() => Encoding.RegisterProvider(CodePagesEncodingProvider.Instance);
    ...
    public static TextureListManifest ParseText(string text, string vfsPathPrefix)
    {
        ...
        foreach (string rawLine in text.Split('\n'))
        {
            ...
            ReadOnlySpan<char> nameSpan = line.AsSpan(0, dotPos);
            string ext = line[dotPos..]; // includes the '.'
            ...
            int texId = ParseLeadingDigits(nameSpan);
