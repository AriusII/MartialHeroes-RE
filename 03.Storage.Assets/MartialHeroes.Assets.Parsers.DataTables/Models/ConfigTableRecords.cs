...
public sealed class ExpCurveEntry
{
    ...
    ///     spec: Docs/RE/formats/config_tables.md §2.3 — "+12 u32 Secondary EXP curve: CONFIRMED (present); semantic
    ///     UNVERIFIED".
    /// </summary>
    ...
    ///     spec: Docs/RE/formats/config_tables.md §2.3 — "+16 u32 Tertiary EXP curve: CONFIRMED (present); semantic
    ///     UNVERIFIED".
    /// </summary>
...
///     spec: Docs/RE/formats/config_tables.md §2.4 — "SPEC CORRECTION from prior version: +4/+8 each a 4-byte u32 step
///     field is wrong; they are 2-byte u16 counters".
/// </remarks>
...
/// </summary>
/// <remarks>
///     spec: Docs/RE/formats/config_tables.md §2.6 users.scr — "496-byte bulk block (4 × 124-byte class blocks)":
///     CONFIRMED.
/// </remarks>
