    ...
    private static SodBlob Parse(ReadOnlySpan<byte> span, ReadOnlyMemory<byte> backing)
    {
        ...
        for (var s = 0; s < (int)solidCount; s++)
        {
            ...
            for (var q = 0; q < (int)quadCount; q++)
            {
                ...
                quads[q] = new SodQuad(
                    BinaryPrimitives.ReadSingleLittleEndian(qSpan[..]),
                    BinaryPrimitives.ReadSingleLittleEndian(qSpan[0x04..]),
                    BinaryPrimitives.ReadSingleLittleEndian(qSpan[0x08..]),
                    BinaryPrimitives.ReadSingleLittleEndian(qSpan[0x0C..]),
                    BinaryPrimitives.ReadSingleLittleEndian(qSpan[0x10..]),
                    BinaryPrimitives.ReadSingleLittleEndian(qSpan[0x14..]),
                    BinaryPrimitives.ReadSingleLittleEndian(qSpan[0x18..]),
                    BinaryPrimitives.ReadSingleLittleEndian(qSpan[0x1C..]),
                    BinaryPrimitives.ReadSingleLittleEndian(qSpan[0x20..]),
                    BinaryPrimitives.ReadSingleLittleEndian(qSpan[0x24..]),
                    BinaryPrimitives.ReadSingleLittleEndian(qSpan[0x28..]),
                    BinaryPrimitives.ReadUInt32LittleEndian(qSpan[0x2C..]));
            }
