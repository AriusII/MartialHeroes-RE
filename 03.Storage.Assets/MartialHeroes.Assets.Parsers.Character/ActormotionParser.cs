...
///             <item>
///                 <term>[0]</term>
///                 <description>col0 — category/direction selector (key input, not stored as standalone field)</description>
///             </item>
///             <item>
///                 <term>[1]</term>
///                 <description>col1 — intra-category offset (key input; equals mob_id for mob entries)</description>
///             </item>
///             <item>
///                 <term>[2]</term><description>col2 — int_a → int field @ record offset 0x04</description>
///             </item>
///             <item>
///                 <term>[3]</term><description>col3 — rate_src_x → float field @ 0x08</description>
///             </item>
///             <item>
///                 <term>[4]</term>
///                 <description>col4 — divisor_x → int field @ 0x28 (interleaved early in stream)</description>
///             </item>
///             <item>
///                 <term>[5]</term><description>col5 — rate_src_y → float field @ 0x0C</description>
///             </item>
///             <item>
///                 <term>[6]</term><description>col6 — divisor_y → int field @ 0x2C (interleaved early)</description>
///             </item>
///             <item>
///                 <term>[7]</term><description>col7 — int_b → int field @ 0x10</description>
///             </item>
///             <item>
///                 <term>[8]</term><description>col8 — float_c → float @ 0x14</description>
///             </item>
///             <item>
///                 <term>[9]</term><description>col9 — float_d → float @ 0x18</description>
///             </item>
///             <item>
///                 <term>[10]</term><description>col10 — float_e → float @ 0x1C</description>
///             </item>
///             <item>
///                 <term>[11]</term><description>col11 — float_f → float @ 0x20</description>
///             </item>
///             <item>
///                 <term>[12]</term><description>col12 — float_g → float @ 0x24</description>
///             </item>
///             <item>
///                 <term>[13]</term><description>col13 — float_h → float @ 0x38</description>
///             </item>
///             <item>
///                 <term>[14]</term><description>col14 — float_i → float @ 0x3C</description>
///             </item>
///             <item>
///                 <term>[15..23]</term><description>motion_ids_a[0..8] → i32[9] @ 0x40</description>
///             </item>
///             <item>
///                 <term>[24..32]</term><description>motion_ids_b[0..8] → i32[9] @ 0x64</description>
///             </item>
///         </list>
///     </para>
///     <para>
...
public static class ActormotionParser
{
    ...
    public static ActormotionCatalogue ParseText(string text, ReadOnlySpan<uint> baseTable)
    {
        ...
        for (var lineIdx = 1; lineIdx < lines.Length; lineIdx++)
        {
            ...
            int.TryParse(cols[ColIntA].Trim(), out var intA); // col2 → 0x04
            float.TryParse(cols[ColRateSrcX].Trim(), NumberStyles.Float,
                CultureInfo.InvariantCulture, out var rateSrcX); // col3 → 0x08
            int.TryParse(cols[ColDivisorX].Trim(), out var divisorX); // col4 → 0x28 (interleaved)
            ...
            var rateX = FpsBase * rateSrcX / divisorX; // spec: Docs/RE/formats/actormotion.md §rate_x @ 0x30
            var rateY = FpsBase * rateSrcY / divisorY; // spec: Docs/RE/formats/actormotion.md §rate_y @ 0x34
