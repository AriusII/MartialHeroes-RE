...
///     spec: Docs/RE/formats/effects.md §A.4.5 — every block (block 0 included) uses the same element read sequence:
///     CONFIRMED.
...
///     spec: Docs/RE/formats/effects.md §A.4.6 emitter_type == 2 adds +12 bytes Euler rotation in static branch:
///     CONFIRMED.
...
/// </summary>
/// <remarks>
///     File header is 8 bytes (0x08): effect_id u32 + sub_effect_count u32. Anti-magic: effect_id must NOT equal
///     0x46464558.
///     spec: Docs/RE/formats/effects.md §A.2 File Header (8 bytes): VERIFIED (2026-06-14 correction from prior 32-byte
///     misreading).
