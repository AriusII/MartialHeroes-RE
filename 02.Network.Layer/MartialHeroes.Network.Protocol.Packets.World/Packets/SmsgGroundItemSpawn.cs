...
public readonly struct SmsgGroundItemSpawn
{
    ...
    /// <summary>
    ///     +0 — source/dropper sort key; low byte 2 = Mob dropper (u32). spec:
    ///     Docs/RE/packets/5-14_ground_item_spawn.yaml.
    /// </summary>
    ...
    /// <summary>
    ///     +16 — reserved hole; not read by the ground-item path (4 bytes). spec:
    ///     Docs/RE/packets/5-14_ground_item_spawn.yaml (Reserved0: bytes[4]).
    /// </summary>
    ...
    /// <summary>
    ///     +24 — world entity key for this ground item; used by CmsgPickupItem (2/15) and 5/15 (i32). spec:
    ///     Docs/RE/packets/5-14_ground_item_spawn.yaml.
    /// </summary>
    ...
    /// <summary>
    ///     +47 — when set, drives a one-shot "rare drop" chat line (u8). spec:
    ///     Docs/RE/packets/5-14_ground_item_spawn.yaml.
    /// </summary>
