...
public readonly struct SmsgActorVisualSlotSet
{
    ...
    public const uint OpcodeId = Opcodes.Opcodes.SmsgActorVisualSlotSet;
    ...
    /// <summary>0x11 — alignment padding to 20 bytes (3 bytes). spec: Docs/RE/packets/5-12_actor_visual_slot_set.yaml (Padding: u8[3]).</summary>
