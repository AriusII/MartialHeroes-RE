...
public readonly struct SmsgSkillWindowStateUpdate
{
    ...
    public const uint OpcodeId = Opcodes.Opcodes.SmsgSkillWindowStateUpdate;
    ...
    /// <summary>Buff slot 0 param X (icon source X or duration per competing reading). spec: Docs/RE/packets/4-102_buff_state.yaml.</summary>
    public readonly int Buff00X;

    /// <summary>Buff slot 0 param Y (icon source Y or stack/flag per competing reading). spec: Docs/RE/packets/4-102_buff_state.yaml.</summary>
