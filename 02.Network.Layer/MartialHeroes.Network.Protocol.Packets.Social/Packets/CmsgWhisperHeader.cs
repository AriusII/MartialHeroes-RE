...
public readonly struct CmsgWhisperHeader
{
    ...
    /// <summary>
    ///     0x00 — channel code selecting say/party/guild/shout/alliance/whisper (VALUE capture-pending). spec:
    ///     packets/2-7_whisper.yaml.
    /// </summary>
    public readonly byte Channel;

    /// <summary>
    ///     0x01 — sub-selector byte the builder writes after the channel; meaning capture-pending. spec:
    ///     packets/2-7_whisper.yaml.
    /// </summary>
